...
gb.serialize.r_mesh = function(br)
{
	...
	var indices = s.r_u32_array(br, 36);
...
gb.webgl = 
{
	...
	*/
	render_draw_call: function(camera, scene, ids, count, material, target, clear)
	{
		var _t = gb.webgl;
		var gl = _t.ctx;
		var n = count;
...
{
	var s = scene.current;
	gl.render_draw_call(s.active_camera, s, s.draw_items, s.num_draw_items, null, surface_target, true);
