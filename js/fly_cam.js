function fly_camera(c, dt, vertical_limit)
{
	...
	vec_lerp(e.rotation, e.rotation, rot_lerp, 0.1);
	...
	mat4_mul_dir(accel, e.world_matrix, accel);

	vec_add(c.velocity, accel, c.velocity);
	vec_mul_f(c.velocity, c.velocity, 0.9);

	vec_add(e.position, c.velocity, e.position);
	e.dirty = true;
