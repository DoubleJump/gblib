    ...
    def mesh(self, ctx, ob, scene):
        ...
        if(mesh.tessfaces):
            ...
            for v in mesh.vertices:
                p = round_vec3(v.co, ctx.vertex_precision) 
...
class ExportTest(bpy.types.Operator, ExportHelper):
    ...
    export_selected = BoolProperty(name="Export Selected", description="Only export selected", default=False)
